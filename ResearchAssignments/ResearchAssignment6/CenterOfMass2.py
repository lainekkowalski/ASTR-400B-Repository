...
# of a given galaxy and simulation snapshot
    ...
    def __init__(self, filename, ptype):
        ...
        a specified particle type. 
            ...
            filename : `str`
                snapshot file
            ptype : `int; 1, 2, or 3`- doesn't say a specific p_num here!
        ...
        #These refer to all positions/velocities of all particles of that type
    ...
    def COMdefine(self,a,b,c,m):
        ...
        a_com = np.dot(a,m) / np.sum(m) #a.m = (a1m1+a2m2...)
    ...
    def COM_P(self, delta, volDec):
        ...
        volDec : 'float'
            defines amount by which Rr_max is decreased
